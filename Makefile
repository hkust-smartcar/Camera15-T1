...
LIBSCCC_BIN_SUFFIX:=$(LIBSCCC_BIN_SUFFIX)-r
...
LDLIBS+=$(addprefix -l,$(ALL_LIBS)) -l$(LIBSCCC_BIN)$(LIBSCCC_BIN_SUFFIX)
...
$(OUT_EXE_PATH)/$(OUT_EXE)$(BIN_SUFFIX)$(OUT_EXE_SUFFIX): $(OBJ_FILES) $(LIBSCCC_BIN_PATH)/lib$(LIBSCCC_BIN)$(LIBSCCC_BIN_SUFFIX).a
